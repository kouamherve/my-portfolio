...
export default function Contact() {
  return (
    ...
    >
      ...
      <h1 className=" text-2xl uppercase tracking-wider">Get in touch!</h1>
      ...
      <button className=" font-normal mb-8 text-black hover:text-white bg-transparent capitalize text-md px-7 py-2.5 border border-black hover:border-violet-600 hover:bg-violet-600 rounded-md">
        Say hello
      </button>
    </section>
  );
